...
<body>
    ...
    <u1 class="nav">
        ...
        <li class="nav-item"> <a class="nav-link" href="forloop.php">Simple for loops</a></li>
        <li class="nav-item"> <a class="nav-link" href="whiledowhileloop.php">Simple While and Do While Loops</a></li>
        ...
        <li class="nav-item"> <a class="nav-link" href="datetimemanip.php">Simple Date Time Manipulation</a></li>
